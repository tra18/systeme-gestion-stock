...
const TestRunner = () => {
  ...
  const testSuites = {
    authentication: {
      ...
      description: 'Vérification du système d\'authentification',
      tests: [
        {
          id: 'auth-login',
        ...
        },
        {
          ...
          description: 'Test des permissions par rôle',
          category: 'authentication',
          priority: 'medium',
          status: 'pending'
        }
    ...
    stock: {
      name: 'Tests de Gestion du Stock',
      description: 'Vérification des fonctionnalités de stock',
      tests: [
        {
          id: 'stock-create',
        ...
        {
          id: 'stock-update',
          name: 'Modification d\'article',
          description: 'Test de modification d\'un article existant',
          category: 'stock',
          priority: 'high',
          status: 'pending'
        },
        {
          id: 'stock-delete',
          name: 'Suppression d\'article',
          description: 'Test de suppression d\'un article',
          category: 'stock',
          priority: 'medium',
          status: 'pending'
        },
        {
          ...
          description: 'Test des alertes de stock faible',
          category: 'stock',
          priority: 'medium',
          status: 'pending'
        }
    ...
    commandes: {
      name: 'Tests de Gestion des Commandes',
      description: 'Vérification du workflow des commandes',
      tests: [
        {
          id: 'commande-create',
        ...
        {
          id: 'commande-workflow',
          name: 'Workflow de commande',
          description: 'Test du processus d\'approbation',
          category: 'commandes',
          priority: 'high',
          status: 'pending'
        },
        {
          id: 'commande-validation',
          name: 'Validation DG',
          description: 'Test de validation par le DG',
          category: 'commandes',
          priority: 'high',
          status: 'pending'
        }
    ...
    ui: {
      name: 'Tests d\'Interface Utilisateur',
      description: 'Vérification de l\'interface utilisateur',
      tests: [
        {
          id: 'ui-responsive',
          name: 'Responsivité',
        ...
        },
        {
          id: 'ui-navigation',
          name: 'Navigation',
          description: 'Test de la navigation entre les pages',
          category: 'ui',
          priority: 'medium',
          status: 'pending'
        },
        {
          id: 'ui-forms',
          name: 'Formulaires',
          description: 'Test de validation des formulaires',
          category: 'ui',
          priority: 'medium',
          status: 'pending'
        }
    ...
    performance: {
      ...
      description: 'Vérification des performances',
      tests: [
        {
          id: 'perf-loading',
          name: 'Temps de chargement',
          description: 'Test des temps de chargement des pages',
        ...
        },
        {
          ...
          description: 'Test de l\'utilisation de la mémoire',
          category: 'performance',
          priority: 'low',
          status: 'pending'
        }
  ...
  const runAllTests = async () => {
    ...
    try {
      ...
      const newCoverage = Math.round((passedTests / totalTests) * 100);
      setCoverage(newCoverage);

      toast.success(`Tests terminés: ${passedTests}/${totalTests} réussis`);
    } catch (error) {
  ...
  const runTestSuite = async (suiteName) => {
    ...
    try {
      ...
      toast.error('Erreur lors de l\'exécution de la suite');
    } finally {
      setIsRunning(false);
    }
  };
  ...
  const resetTests = () => {
    ...
    setTestResults({});
    setCoverage(0);
    toast.success('Tests réinitialisés');
  };
  ...
  const getCategoryIcon = (category) => {
    switch (category) {
      ...
      case 'commandes': return <ShoppingCart className="h-4 w-4" />;
      case 'ui': return <Database className="h-4 w-4" />;
